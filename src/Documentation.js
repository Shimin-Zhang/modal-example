    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-8 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
          ...
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Modal Overview</h1>
        ...
        <div class="flex flex-col text-center w-full mb-20">
          <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">Demo</h2>
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Demo Modal</h1>
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
            <DemoButton1 />
            <DemoButton2 />
          </p>
        ...
        <div class="flex flex-col text-center w-full mb-20">
          ...
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Common Use Cases</h1>
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
        ...
        <div class="flex flex-col text-center w-full mb-20">
          ...
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Usage Best Practices </h1>
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
        ...
        <div class="flex flex-col text-center w-full mb-20">
          <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">Specs</h2>
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Design Specifications</h1>
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
        ...
        <div class="flex flex-col text-center w-full mb-20">
          <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">Accessibility</h2>
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Accessibility Concerns</h1>
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
